...
Gem::Specification.new do |s|
  ...
  s.files = ["CHANGELOG.rdoc", "README", "lib/capistrano/ext/assets/request-counter.rb", "lib/capistrano/ext/monitor.rb", "lib/capistrano/ext/multistage.rb", "lib/capistrano/ext/version.rb"]
